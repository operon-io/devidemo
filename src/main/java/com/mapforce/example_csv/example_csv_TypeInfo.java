...
package com.mapforce.example_csv;

import com.altova.typeinfo.*;



public class example_csv_TypeInfo {
	// namespaces indices
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _id = _altova_mi_altova_RowsType.begin ;
		public static final int _date2 = 2 ;
		public static final int _arrival = 3 ;
		public static final int _departure = 4 ;
		public static final int _extra_info = 5 ;
		public static final int _firstname = 6 ;
		public static final int _lastname = 7 ;
		public static final int _address = 8 ;
		public static final int _city = 9 ;
		public static final int _zipCode = 10 ;
		public static final int _mobilePhone = 11 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator {
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[1] = new MemberInfo (binder, "", "id", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[2] = new MemberInfo (binder, "", "date", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[3] = new MemberInfo (binder, "", "arrival", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[4] = new MemberInfo (binder, "", "departure", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[5] = new MemberInfo (binder, "", "extra_info", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[6] = new MemberInfo (binder, "", "firstname", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[7] = new MemberInfo (binder, "", "lastname", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[8] = new MemberInfo (binder, "", "address", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[9] = new MemberInfo (binder, "", "city", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[10] = new MemberInfo (binder, "", "zipCode", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[11] = new MemberInfo (binder, "", "mobilePhone", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);

			members[12] = new MemberInfo (binder, "", "", _altova_ti_altova_stringType, _altova_ti_altova_string2, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

		}

		public MemberInfo[] createMembers(InfoBinderInterface binder) {

			MemberInfo members[] = new MemberInfo[13];
