...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jTy_ajanseuranta_CSVLabel0 = new JLabel();
	JTextField jTy_ajanseuranta_CSVTextField0 = new JTextField();

	JLabel jworktimeJson2Label1 = new JLabel();
	JTextField jworktimeJson2TextField1 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2022r2");
	...
	protected void fillScrollPane() {
		...
		jTy_ajanseuranta_CSVLabel0.setText("Source instance of Ty\u00f6ajanseuranta_CSV file:");
		jTy_ajanseuranta_CSVLabel0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jTy_ajanseuranta_CSVLabel0, null);
		jTy_ajanseuranta_CSVTextField0.setText("example_csv.csv");
		jTy_ajanseuranta_CSVTextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jTy_ajanseuranta_CSVTextField0.setEditable(false);
		jPanelStructures.add(jTy_ajanseuranta_CSVTextField0, null);
